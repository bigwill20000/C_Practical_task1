...
DEGREEPROGRAM *delete_begin(DEGREEPROGRAM*);
DEGREEPROGRAM *delete_end(DEGREEPROGRAM*);
DEGREEPROGRAM *delete_pos(DEGREEPROGRAM*);
DEGREEPROGRAM *delete_methods(DEGREEPROGRAM*);

void display(DEGREEPROGRAM*);
void display_list(DEGREEPROGRAM*);
////void delete_entire_list(DEGREEPROGRAM*)
